...
describe('Event Service', () => {
    ...
    it('should create an event', async () => {
        ...
        prisma.events.create.mockResolvedValue(mockEvent);
    ...
    it('should get a list of events without conditions', async () => {
        ...
        prisma.events.findMany.mockResolvedValue(mockEvents);
    ...
    it('should update an event', async () => {
        const mockEvent = { id: 1, eventTypeId: 1, datetime: new Date() };
        prisma.events.update.mockResolvedValue(mockEvent);
    ...
    it('should delete an event', async () => {
        const mockEvent = { id: 1, eventTypeId: 1, datetime: new Date() };
        prisma.events.delete.mockResolvedValue(mockEvent);
